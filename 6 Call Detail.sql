...
--to add another partitions

alter table Call_detail add partition (partition p3 values less than (unix_timestamp('2023-02-01 00.00.00')));

--to remove partitions

 alter table Call_detail drop  partition p3;
